// src/components/dashboard/LazyUserStats.js
"use client";
...
export default function LazyUserStats() {
  ...
  // If stats are shown, render the UserStats component
  if (showStats) {
    return (
      <div ref={wrapperRef}>
        <UserStats />
      ...
      >
        <div>
          ...
          <p className='text-slate-600 mt-1'>
            View your lifetime test performance, including tests taken and
            average score.
          </p>
        </div>
      </button>
